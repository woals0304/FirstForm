...
{
    internal static class PlayModeRuntimeReflection
    {
        ...
        public static UnityEngine.Object FindObject(string fullTypeName)
        {
            return UnityEngine.Object.FindObjectOfType(Type(fullTypeName));
        }
        ...
        {
            MethodInfo method = FindMethod(Type(fullTypeName), methodName, arguments.Length, AnyStatic);
